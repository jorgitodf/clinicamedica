...
class EmailsFixture extends TestFixture
{
    ...
    public $fields = [
        'id_email' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_email'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
